    ...
    implements javax.jms.MessageListener
{
    ...
    private int filter_type_id = 0;
 

    /** Create JMS client for sending and receiving messages. */
    private void talker( String broker, String username, String password, String rQueue, String sQueue, int filter_type_id)
    {
        ...
        try
        {
            ...
            if (rQueue != null)
            {
                ...
                switch(filter_type_id){
                    case 0: qReceiver = receiveSession.createConsumer(receiveQueue, "typeMess = 'important'"); break;
                    case 1: qReceiver = receiveSession.createConsumer(receiveQueue, "typeMess2 = 'important'"); break;
                    default:
                        qReceiver = receiveSession.createConsumer(receiveQueue, "typeMess = 'important'"); 
                }
        ...
        try
        {
            ...
            while ( true )
            {
                ...
                else if ( s.length() > 0 && sQueue != null)
                {
                    ...
                    msg.setJMSType("MAP");
                    msg.setString("Auteur", username);
                    msg.setInt("Value", i);
                    msg.setString("Message", s);

                    if(i % 2 == 0) msg.setStringProperty("typeMess", "important");
                    else msg.setStringProperty("typeMess2", "important");
    ...
    public void onMessage( javax.jms.Message aMessage)
    {
        try
        {
            ...
            if (aMessage instanceof javax.jms.MapMessage)
            {
            	...
            	javax.jms.MapMessage mapMessage = (javax.jms.MapMessage) aMessage;
            	...
            	try
            	{
                    ...
                    System.out.println("author = " + mapMessage.getString("Auteur") + ", value = " + mapMessage.getInt("Value") + ", message : " + mapMessage.getString("Message"));
    ...
    public static void main(String argv[]) {
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            if (!arg.startsWith("-")) {
                ...
                if(arg.equals("-f")){
                    ...
                    filter_type_id = Integer.parseInt(argv[++i]);
                    continue;
                }
        ...
        Talk talk = new Talk();
        talk.talker (broker, username, password, qReceiver, qSender, filter_type_id);
